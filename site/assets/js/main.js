...
//CÓDIGO PARA ABRIR AS BOLINHAS PARA OUTRAS PÁGINAS
...
// document.getElementById('bolinha-um').forEach(function(element) {
	...
	document.getElementById('bolinha-dois').addEventListener('click', function(event) {
        // Previne a navegação padrão do link
        event.preventDefault();
	...
	document.getElementById('bolinha-tres').addEventListener('click', function(event) {
        // Previne a navegação padrão do link
        event.preventDefault();
